...
def create_network(network_input, n_vocab):
    ...
    # Load the weights to each node (format: weights-improvement-{epoch:02d}-{loss:.4f}-bigger.hdf5)
    cwd = Path.cwd()
    model_name = 'model/weights-improvement-03-5.2817-bigger.hdf5'
    model_path = (cwd / model_name).resolve()
...
def create_midi(prediction_output):
    ...
    relative_path_output = 'static/test_output.mid'
    output_path = (cwd / relative_path_output).resolve()
    print("MIDI output path:", output_path)
    midi_stream.write('midi', fp=output_path)


    return 'static/test_output'
...
def generate():
    ...
    cwd = Path.cwd()
    print("Current directory: ", cwd)
    relative_path_notes = 'model/MIDI/data/notes'
